...
⏳ زمان پاسخگویی معمولاً کمتر از ۲۴ ساعت است.`
  );
});
...
آمادگی مناسبی برای ورود به ساختارهای سرمایه‌گذاری دارید.

به‌منظور حفظ تعادل مدیریت سرمایه،
ظرفیت این سطح محدود نگه داشته می‌شود.
...
bot.action("plans", async (ctx) => {
  ...
  await ctx.editMessageText(
`🏦 پلن‌های سرمایه‌گذاری فعال

سرمایه شما پس از تأیید تراکنش،
در استخرهای نقدینگی معتبر و فرصت‌های Yield محور
در اکوسیستم TON تخصیص داده می‌شود.

بدون تضمین سود ثابت.
بازده وابسته به عملکرد واقعی بازار است.

سطح موردنظر را انتخاب کنید:`,
    Markup.inlineKeyboard([
      [Markup.button.callback("🌱 Horizon 30 TON | ---٪ ماهانه", "plan_30")],
      [Markup.button.callback("⚡ Momentum 50 TON | ---٪ ماهانه", "plan_50")],
      [Markup.button.callback("🔥 Apex 100 TON | ---٪ ماهانه", "plan_100")],
      [Markup.button.callback("👑 Titan 200 TON | ---٪ ماهانه", "plan_200")]
    ])
  );
});
...
(مقادیر وابسته به عملکرد واقعی بازار است)
